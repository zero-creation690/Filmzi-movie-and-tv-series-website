  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        ...
        const filtered = data.filter((item: any) => item.language.toLowerCase() === language.toLowerCase())
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">{language} Content</h1>
        ...
        {content.length === 0 ? (
          <div className="text-center py-16">
            <p className="text-muted-foreground text-lg">No content found in this language.</p>
          </div>
        ) : (
          <Tabs defaultValue="all" className="w-full">
            ...
            <TabsContent value="movies" className="mt-6">
              {movies.length > 0 ? (
                ...
                <div className="text-center py-16">
                  <p className="text-muted-foreground">No movies found in this language.</p>
                </div>
              )}
            </TabsContent>
            ...
            <TabsContent value="tv" className="mt-6">
              {tvSeries.length > 0 ? (
                ...
                <div className="text-center py-16">
                  <p className="text-muted-foreground">No TV series found in this language.</p>
                </div>
              )}
            </TabsContent>
          </Tabs>
